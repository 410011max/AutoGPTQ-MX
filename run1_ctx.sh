...
# model_name=/home/scott306lr_l/hf/models/meta-llama/Llama-2-7b-hf/
n_ctx_arr=(512 1024 2048 4096)
...
echo -e "n_ctx\t|int8\t|fp6_e3m2\t|fp4\t|int4"
echo -e "----------------------------------------"
for n_ctx in ${n_ctx_arr[@]}
do
    echo -e "$n_ctx\t|${ppl_arr[$n_ctx,fp16]}\t|${ppl_arr[$n_ctx,int8]}\t|${ppl_arr[$n_ctx,fp6_e3m2]}\t|${ppl_arr[$n_ctx,fp4]}\t|${ppl_arr[$n_ctx,int4]}"
done
echo -e "\n\n"
exit 0


# python examples/benchmark/perplexity.py --model_name /home/scott306lr_l//hf/models/meta-llama/Llama-2-7b-hf/ --mx --mx_format int8
